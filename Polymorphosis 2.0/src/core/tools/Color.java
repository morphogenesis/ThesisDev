...
//	public static final int ACTIVE_FILL = 0xffFFFFFF;
    ...
    public static final int STANDARD = 0xff666666;

    //	public static final int SELECTED_FILL = 0xffcccccc;
    public static final int[] ORIGIN = {0xffF15800, 0xffF15800};
    ...
    public static String hsvToRgb(float hue, float saturation, float value) {
        ...
        switch (h) {
            ...
            default:
                throw new RuntimeException("Error converting HSV to RGB.Input was " + hue + ", " + saturation + ", " + value);
        }
    }
